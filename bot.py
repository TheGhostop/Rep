...
from handlers.login import add_session, verify_sessions
from handlers.check_accounts import check_admin_accounts, check_total_accounts

# Bot credentials
API_ID = 26510660
API_HASH = "1c5017dbd3cbb417770c19d4a5645fa2"
BOT_TOKEN = "7818162640:AAGmIkrkd8kxaglbNFBpXxrP7bAL6c2sEOk"
OWNER_ID = 7046757969
...
async def start(update: Update, context):
    ...
    if user_id != OWNER_ID:
        await update.message.reply_text("Access Denied. Only the owner can use this bot.")
        return
